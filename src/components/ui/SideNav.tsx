...
const QUOTES = [
  '"The intelligent investor is a realist who sells to optimists and buys from pessimists." — Graham',
...
const NAV = [
  ...
  { href: '/autopilot',   label: 'Autopilot',         icon: 'M13 10V3L4 14h7v7l9-11h-7z', badge: 'live' },
  ...
  { href: '/philosophy',  label: 'Philosophy Engine', icon: 'M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.747 0 3.332.477 4.5 1.253v13C19.832 18.477 18.247 18 16.5 18c-1.746 0-3.332.477-4.5 1.253', count: 241 },
  ...
  return (
    <aside className="flex h-screen w-[220px] shrink-0 flex-col border-r border-zinc-800/80 bg-zinc-950">
      ...
      <div className="px-5 pt-6 pb-5 border-b border-zinc-800/80">
        ...
        <div className="mt-3 text-[10px] text-zinc-600 tracking-wide">Systematic Value Intelligence</div>
      </div>
        ...
        {NAV.map((item) => {
          ...
          return (
            ...
            >
              ...
              {item.count != null && (
                <span className={cn('text-[10px] tabular-nums', isActive ? 'text-violet-500' : 'text-zinc-700')}>
                  {item.count}
                </span>
              )}
            </Link>
      ...
      {/* Quote */}
      <div className="px-4 pb-5 pt-2 border-t border-zinc-800/80">
        <p suppressHydrationWarning className="text-[10px] italic leading-relaxed text-zinc-700">{QUOTES[quoteIdx]}</p>
      </div>
    </aside>
  )
}
